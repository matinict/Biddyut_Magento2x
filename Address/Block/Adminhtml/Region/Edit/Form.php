...
namespace Sslwireless\Address\Block\Adminhtml\Region\Edit;
...
class Form extends Generic
{
    ...
    protected function _prepareForm()
    {
        ...
        $country_list = $this->_coreRegistry->registry('sslwireless_address_country_list');
        $fieldset->addField(
            'country_id',
            'select',
            [
        ...
        $formData = $this->_coreRegistry->registry('sslwireless_address_region');
        if ($formData) {
